...
public sealed class FeatureProviderTests
{
    ...
    public async Task GetFeatureStateAsync_WhenCalled_ReturnsFeatureStateResponse()
    {
        ...
        var featureState = new FeatureStateResponse(featureName, true);
        _repository.GetFeatureStateAsync(featureName, environmentKey).Returns((featureState.IsEnabled, true));
    ...
    public async Task AddEnvironmentToFeatureAsync_WhenCalled_ReturnsOk()
    {
        ...
        // Act
        var result = await _featureProvider.AddEnvironmentToFeatureAsync(featureKey, environmentKey, authKey);
    ...
    public async Task DeleteFeatureAsync_WhenCalled_ReturnsOk()
    {
        ...
        // Act
        var result = await _featureProvider.DeleteFeatureAsync(featureKey, authKey);
    ...
    public async Task DeleteEnvironmentFromFeatureAsync_WhenCalled_ReturnsOk()
    {
        ...
        // Act
        var result = await _featureProvider.DeleteEnvironmentFromFeatureAsync(featureKey, environmentKey, authKey);
